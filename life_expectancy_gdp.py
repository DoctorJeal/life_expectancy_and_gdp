...
ax = plt.bar(df.Country, df.GDP, color="Green")
...
plt.bar(df.Country, df.LEABY,color='Orange')
plt.title('Life Expectancy by Country')
plt.ylabel('Age in Years')
plt.savefig('Life Expectancy by Country')
plt.show()
...
ax = sns.violinplot(df.Country, df.LEABY, palette='Accent')
ax.set_title('Life Expectancy by Country')
plt.savefig('life expectancy distribution by country.png')
plt.show()
...
# 2. 2010
# 3. Mexico
# 4. Most follow a similar growth trend with the greatest change in Zimbarbwe
# 5. insignificant
# 6. 
...
# 2. 2010
# 3. USA
# 4. Emerging coubtries have higher growth rates
...
# 1. Zimbabwe and Chile

# Which countries have the highest and lowest life expectancy?

# 1. Chile, Germnay, USA and Mexico
...
# What is responceble for Zimbabwees rise in LEABY over the last 10 years in comparison to other countries?
